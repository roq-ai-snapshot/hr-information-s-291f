  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="HR Information System - Your one-stop solution for managing employee data, vacations, and payroll, empowering your workforce and optimizing your business."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`HR Information System - Your one-stop solution for managing employee data, vacations, and payroll, empowering your workforce and optimizing your business.`}
            </Text>
            <Box
